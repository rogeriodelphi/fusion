# Generated by Django 2.2.5 on 2019-11-04 05:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icone', models.CharField(choices=[('Ini_status-up', 'Gráfico'), ('Ini-mobile', 'Mobile'), ('Ini_cog', 'Engrenagem'), ('lni-users', 'Usuários'), ('Ini-layers', 'Design'), ('Ini-rocket', 'Foguete')], max_length=12, verbose_name='Ícone')),
            ],
        ),
        migrations.CreateModel(
            name='Equipe',
